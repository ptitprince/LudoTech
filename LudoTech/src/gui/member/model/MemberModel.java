...
public class MemberModel extends AbstractTableModel {
	...
	private final String[] HEADERS = { TextView.get("memberID"), TextView.get("firstName"), 
			TextView.get("lastName"), TextView.get("pseudo"), TextView.get("password"), TextView.get("isAdmin"), TextView.get("birthDate"),
			TextView.get("phoneNumber"),TextView.get("email"), TextView.get("streetAddress"), TextView.get("postalCode"),
			TextView.get("city")};
