...
public class MembersController extends JPanel {
	...
	private void makeListeners() {
		...
		// // Double clic sur une ligne -> Affichage et chargement des
		// informations
		...
		// profileView.load(member.getFirstName(), member.getLastName(),
		// member.getPseudo(), member.getPassword(),
		// member.getIsAdmin(), member.getBirthDate(), member.getPhoneNumber(),
		// member.getEmail(), member.getStreetAddress(),
		...
		// this.memberSearchView.getSearchButton().addActionListener(new
		// ActionListener() {
		...
		// });
		//
		// this.memberListView.getAddGameButton().addActionListener(new
		// ActionListener() {
		// public void actionPerformed(ActionEvent e) {
		// profileView.load("", "", "", "", false,
		// Calendar.getInstance().getTime(), "", "", "", "", "");
		// profileView.setVisible(true);
		// }
		// });
		//
		// this.memberListView.getDeleteGameButton().addActionListener(new
		// ActionListener() {
		// public void actionPerformed(ActionEvent e) {
		// JTable table = memberListView.getTable();
		...
		// int memberID = (Integer)
		// table.getModel().getValueAt(selectedRowIndex, 0);
